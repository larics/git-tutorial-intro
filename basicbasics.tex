...
\begin{block}{Forking}
	To fork a repo, simply click the \includegraphics[scale=0.35]{fork} icon in the top right corner of the repo webpage. For this tutorial, you will need to clone the \href{https://github.com/larics/git-tutorial-code.git}{larics/git-tutorial-code} repo.
\end{block}

\begin{block}{Task: Add a collaborator to your repo}
Choose one of the cloned repositories. In the GitHub user interface, on the \includegraphics[scale=0.35]{settings} tab, select the \texttt{Collaborators and teams} menu and add your partner as a collaborator with \texttt{Write} access.
\end{block}
