...
%	\end{itemize}
%
%\begin{block}{Task I [Yoda, Luke]: Discarding several unwanted changes}
%	\begin{itemize}
...
%	\end{itemize}
%
%	\begin{block}{Task N [Luke]: Luke gets his revenge}
%	\begin{itemize}
%	\item Revert Yoda's annoying commit.
%
%	\end{itemize}
%	\end{block}
%	
...
%	\end{enumerate}
%
%	\begin{block}{Task O [Luke]}
%	Amend the description of the revert commit that you have just made: \texttt{Revert Yoda's rudeness}. Push the revert commit.
%
%\end{block}
%
%	\begin{block}{Task P [Yoda]}
%	Pull Luke's changes.	
%	\end{block}
%
%
