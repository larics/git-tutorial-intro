...
\setbeamertemplate{itemize item}{\raisebox{0.25ex}{\small\textbullet}\hskip0.1em}
\setbeamertemplate{itemize subitem}{\raisebox{0.25ex}{\scriptsize\textbullet}\hskip0.1em}
...
\setbeamertemplate{enumerate item}{
  \hbox{%
    ...
    \raisebox{2pt}{%
    \vrule width3ex height2.25ex depth.8ex%
    \hskip-4ex%
    \hbox to5ex{%
      \hfil%
